...
function PrivacyPolicy() {
  return (
    <div className="site" dir="rtl" style={{ padding: "40px", color: "white" }}>
      <h1>سياسة الخصوصية</h1>
      <p>آخر تحديث: 1 يوليو 2026</p>

      <h2>تطبيق خبرني</h2>
      <p>
        يحترم تطبيق خبرني خصوصية المستخدمين، ويهدف إلى تقديم معلومات وخدمات
        محلية مثل أسعار العملات والذهب والمياه والصيدليات المناوبة والإشعارات
        المهمة.
      </p>

      <h2>البيانات التي يجمعها التطبيق</h2>
      <p>
        لا يطلب التطبيق إنشاء حساب ولا يجمع الاسم أو رقم الهاتف أو البريد
        الإلكتروني. قد يستخدم التطبيق معرفًا تقنيًا للجهاز لأغراض الإحصائيات
        وتحسين الخدمة.
      </p>

      <h2>الإشعارات</h2>
      <p>
        يستخدم التطبيق Firebase Cloud Messaging لإرسال إشعارات حول التحديثات
        المهمة. يمكن للمستخدم إيقاف الإشعارات من إعدادات الجهاز في أي وقت.
      </p>

      <h2>الإعلانات</h2>
      <p>
        قد يعرض التطبيق إعلانات من Google AdMob أو خدمات مشابهة، وقد تستخدم هذه
        الخدمات معرفات إعلانية وفقًا لسياساتها الخاصة.
      </p>

      <h2>مشاركة البيانات</h2>
      <p>
        لا نقوم ببيع بيانات المستخدمين أو مشاركتها مع أطراف خارجية، باستثناء
        الخدمات التقنية اللازمة لتشغيل التطبيق مثل Firebase وخدمات الإعلانات.
      </p>

      <h2>التواصل</h2>
      <p>
        لأي استفسار بخصوص سياسة الخصوصية يمكن التواصل عبر البريد الإلكتروني:
        <br />
        mahyar.rez.26@gmail.com
      </p>
    </div>
  );
}
